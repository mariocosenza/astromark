...
VALUES
    ...
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), 'Avvio corsi di recupero', 'Comunicazione sull''avvio dei corsi di recupero di matematica.', '2024-12-15'),
    ...
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), 'Assemblea di classe', 'Convocazione per l’assemblea di classe del mese.', '2025-01-28'),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), 'Distribuzione materiale scolastico', 'Comunicazione sulla distribuzione del materiale per il laboratorio.', '2025-01-27'),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), 'Incontro con esperti', 'Conferenza con esperti sul tema delle energie rinnovabili.', '2025-01-26'),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), 'Prova di evacuazione', 'Comunicazione sulla prova di evacuazione programmata.', '2025-01-25'),
    ((SELECT id FROM school_class WHERE number = 2 AND letter = 'B' AND year = 2024), 'Attività sportiva', 'Partecipazione a una giornata di sport interscolastica.', '2025-01-24'),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), 'Simulazione esame di maturità', 'Programmazione della prima simulazione per l’esame di maturità.', '2025-01-23'),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), 'Progetto PCTO', 'Presentazione del progetto di PCTO per l’anno in corso.', '2025-01-22');
...
VALUES
    ...
    ((SELECT id FROM student WHERE username = 'giulia.rossi'), false, true, 'Ritardo causato da traffico.', '2025-01-25 08:30:00'),
    ...
    ((SELECT id FROM student WHERE username = 'alessandro.bastoni'), false, true, 'Ritardo dovuto a problemi di trasporto.', '2025-01-27 08:35:00'),
    ((SELECT id FROM student WHERE username = 'lorenzo.insigne'), true, false, null, '2025-01-24 08:50:00'),
    ((SELECT id FROM student WHERE username = 'ciro.immobile'), false, true, 'Traffico intenso a causa di un incidente.', '2025-01-15 08:45:00'),
    ((SELECT id FROM student WHERE username = 'marco.verratti'), true, false, null, '2025-01-19 08:55:00'),
    ((SELECT id FROM student WHERE username = 'nicolo.barella'), false, true, 'Autobus in ritardo.', '2025-01-22 08:30:00'),
    ((SELECT id FROM student WHERE username = 'sandrom.tonali'), true, false, null, '2025-01-21 08:20:00'),
    ((SELECT id FROM student WHERE username = 'mattia.zaccagni'), false, true, 'Problemi tecnici sulla metro.', '2025-01-14 08:35:00'),
    ((SELECT id FROM student WHERE username = 'giacomo.raspadori'), true, false, null, '2025-01-20 08:25:00'),
    ((SELECT id FROM student WHERE username = 'andrea.belotti'), false, true, 'Problemi di traffico imprevisti.', '2025-01-29 08:45:00'),
    ((SELECT id FROM student WHERE username = 'manuel.locatelli'), true, false, null, '2025-01-17 08:40:00'),
    ((SELECT id FROM student WHERE username = 'matteo.pessina'), false, true, 'Ritardo a causa di un treno guasto.', '2025-01-28 08:50:00'),
    ((SELECT id FROM student WHERE username = 'giovanni.di_lorenzo'), true, false, null, '2025-01-11 08:55:00'),
    ((SELECT id FROM student WHERE username = 'davide.calabria'), false, true, 'Problemi di trasporto pubblico.', '2025-01-25 08:30:00'),
    ((SELECT id FROM student WHERE username = 'nicolò.zaniolo'), true, false, null, '2025-01-16 08:20:00'),
    ((SELECT id FROM student WHERE username = 'alessio.romagnoli'), false, true, 'Incidente stradale.', '2025-01-12 08:40:00'),
    ((SELECT id FROM student WHERE username = 'pluto.pippo'), true, false, null, '2025-01-09 08:15:00'),
    ((SELECT id FROM student WHERE username = 'pl.pi'), false, true, 'Ritardo per traffico intenso.', '2025-01-15 08:20:00'),
    ((SELECT id FROM student WHERE username = 'pluton.paperino'), true, false, null, '2025-01-19 08:25:00'),
    ((SELECT id FROM student WHERE username = 'marco.neri'), false, true, 'Mezzi pubblici in ritardo.', '2025-01-21 08:30:00'),
    ((SELECT id FROM student WHERE username = 'luca.verdi'), true, false, null, '2025-01-14 08:40:00'),
    ((SELECT id FROM student WHERE username = 'sofia.bianchi'), false, true, 'Problemi familiari urgenti.', '2025-01-13 08:10:00'),
    ((SELECT id FROM student WHERE username = 'giulia.rossi'), true, false, null, '2025-01-10 08:35:00'),
    ((SELECT id FROM student WHERE username = 'elisa.verdi'), false, true, 'Sciopero dei mezzi pubblici.', '2025-01-22 08:50:00'),
    ((SELECT id FROM student WHERE username = 'franco.blui'), true, false, null, '2025-01-27 08:05:00'),
    ((SELECT id FROM student WHERE username = 'chiara.neri'), false, true, 'Problemi di salute.', '2025-01-23 08:45:00'),
    ...
    ((SELECT id FROM student WHERE username = 'giada.vitali'), false, true, 'Incidenti stradali lungo il percorso.', '2025-01-24 08:30:00'),
    ((SELECT id FROM student WHERE username = 'matteo.romano'), true, false, null, '2025-01-29 08:50:00'),
    ((SELECT id FROM student WHERE username = 'valentina.mancini'), false, true, 'Problemi di trasporto.', '2025-01-18 08:45:00'),
    ((SELECT id FROM student WHERE username = 'matteo.fontana'), true, false, null, '2025-01-11 08:25:00'),
    ((SELECT id FROM student WHERE username = 'sofia.russo'), false, true, 'Traffico anomalo in zona.', '2025-01-16 08:15:00'),
    ((SELECT id FROM student WHERE username = 'elisa.gallo'), true, false, null, '2025-01-14 08:35:00'),
    ((SELECT id FROM student WHERE username = 'davide.marino'), false, true, 'Problemi alla sveglia.', '2025-01-17 08:40:00');
...
VALUES
    ...
    ((SELECT id FROM student WHERE username = 'valentina.mancini'), false, true, 'Visita specialistica.', '2025-01-27'),
    ...
    ((SELECT id FROM student WHERE username = 'matteo.romano'), true, true, 'Assenza giustificata per emergenza familiare.', '2025-01-21'),
    ...
    ((SELECT id FROM student WHERE username = 'ciro.immobile'), true, true, 'Partecipazione a evento sportivo.', '2025-01-18'),
    ...
    ((SELECT id FROM student WHERE username = 'manuel.locatelli'), true, true, 'Assenza giustificata per motivi personali.', '2025-01-17'),
    ((SELECT id FROM student WHERE username = 'davide.calabria'), false, true, 'Partecipazione a gara sportiva.', '2025-01-24'),
    ...
    ((SELECT id FROM student WHERE username = 'giovanni.di_lorenzo'), false, true, 'Visita specialistica.', '2025-01-22'),
    ...
    ((SELECT id FROM student WHERE username = 'emanuele.naselli'), true, true, 'Motivazione personale.', '2025-01-26'),
    ...
    ((SELECT id FROM student WHERE username = 'alessandro.rinaldi'), true, true, 'Emergenza familiare.', '2025-01-21'),
...
VALUES
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'marco.neri')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'luca.verdi')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'sofia.bianchi')),
    ...
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'alessia.caputo')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'lorenzo.costa')),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'michele.pellegrini')),
    ((SELECT id FROM school_class WHERE number = 2 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'matteo.fontana')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'sofia.russo')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'elisa.gallo')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'giada.vitali')),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'matteo.romano')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'davide.marino')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'giovanni.ferrari')),
    ((SELECT id FROM school_class WHERE number = 2 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'chiara.morini')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'andrea.giusti')),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'alessandro.rinaldi')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'gianluigi.donnarumma')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'alessandro.bastoni')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'federico.chiesa')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'valentina.mancini')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'lorenzo.insigne')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'ciro.immobile')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'marco.verratti')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'nicolo.barella')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'sandrom.tonali')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'mattia.zaccagni')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'giacomo.raspadori')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'andrea.belotti')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'manuel.locatelli')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'matteo.pessina')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'giovanni.di_lorenzo')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'davide.calabria')),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'mario.pasalic')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'danilo.cataldi')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'nicolò.zaniolo')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'alessio.romagnoli')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'cristiano.biraghi')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), (SELECT id FROM student WHERE username = 'alex.meret')),
    ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'salvatore.esposito')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'daniele.rugani')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024), (SELECT id FROM student WHERE username = 'matteo.politano')),
    ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), (SELECT id FROM student WHERE username = 'francesco.acciarini')),
    ((SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024), (SELECT id FROM student WHERE username = 'emanuele.naselli'));
