...
VALUES (NULL, (SELECT id FROM teacher WHERE username = 'marco.gialli'), 'Problema con la piattaforma', 'Tecnico',
       ...
       ((SELECT id FROM parent WHERE username = 'paolo.verdi'), NULL, 'Richiesta informazioni sulla gita',
        'Segreteria', '2025-01-17 10:32:46', FALSE, FALSE),
       ((SELECT id FROM parent WHERE username = 'giulia.neri'), NULL, 'Problema iscrizione', 'Accesso',
        '2025-01-22 10:00:00', FALSE, FALSE),
       ((SELECT id FROM parent WHERE username = 'roberto.verdi'), NULL, 'Richiesta documenti', 'Segreteria',
       ...
       ((SELECT id FROM parent WHERE username = 'laura.bianchi'), NULL, 'Problemi con il registro elettronico',
        'Tecnico', '2024-12-10 09:45:00', FALSE, FALSE),
       ...
       ((SELECT id FROM parent WHERE username = 'giovanna.bastoni'), NULL, 'Problema con la pagella elettronica',
        'Tecnico', '2025-01-05 08:30:00', FALSE, FALSE),
       ((SELECT id FROM parent WHERE username = 'maria.insigne'), NULL, 'Domanda su esami finali', 'Didattica',
       ...
       ((SELECT id FROM parent WHERE username = 'giulia.calabria'), NULL, 'Richiesta informazioni su laboratori',
        'Didattica', '2024-12-23 09:40:00', FALSE, FALSE);
