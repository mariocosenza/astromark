...
VALUES ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), 'Incontro con i genitori',
       ...
       ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), 'Avvio corsi di recupero',
        'Comunicazione sull''avvio dei corsi di recupero di matematica.', '2024-12-25'),
       ...
       ((SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024), 'Assemblea di classe',
        'Convocazione per l’assemblea di classe del mese.', '2025-02-01'),
       ...
       ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024), 'Incontro con esperti',
        'Conferenza con esperti sul tema delle energie rinnovabili.', '2025-02-10'),
       ((SELECT id FROM school_class WHERE number = 1 AND letter = 'C' AND year = 2024), 'Prova di evacuazione',
        'Comunicazione sulla prova di evacuazione programmata.', '2025-02-15'),
       ((SELECT id FROM school_class WHERE number = 2 AND letter = 'B' AND year = 2024), 'Attività sportiva',
        'Partecipazione a una giornata di sport interscolastica.', '2025-02-20'),
       ...
       ((SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024), 'Progetto PCTO',
        'Presentazione del progetto di PCTO per l’anno in corso.', '2025-03-01');
...
VALUES ('SS12345', 'giorgio.neri', 'giorgio.neri@gmail.com', ENCODE(sha512('Neri123*'::BYTEA), 'hex'), 'Giorgio',
...
INSERT INTO student (school_code, username, email, password, name, surname, tax_id, birth_date, residential_address,
                     gender, pending_state)
VALUES ('SS12345', 'marco.neri', 'marco.neri@gmail.com', ENCODE(sha512('Neri123*'::BYTEA), 'hex'), 'Marco', 'Neri',
...
VALUES ((SELECT id FROM student WHERE username = 'luca.verdi'), 'Matematica',
        (SELECT id FROM teacher WHERE username = 'marco.gialli'), '2025-01-22', 'ORAL', 8,
        'Interrogazione su funzioni.'),
       ((SELECT id FROM student WHERE username = 'sofia.bianchi'), 'Matematica',
        (SELECT id FROM teacher WHERE username = 'marco.gialli'), '2025-01-22', 'ORAL', 6,
        'Interrogazione su funzioni incompleta.'),
       ((SELECT id FROM student WHERE username = 'marco.neri'), 'Matematica',
        (SELECT id FROM teacher WHERE username = 'marco.gialli'), '2025-02-01', 'WRITTEN', 7, 'Test sulle equazioni.'),
       ((SELECT id FROM student WHERE username = 'marco.neri'), 'Storia',
        (SELECT id FROM teacher WHERE username = 'riccardo.blui'), '2025-02-15', 'ORAL', 6,
        'Interrogazione sul Rinascimento.'),
       ((SELECT id FROM student WHERE username = 'sofia.bianchi'), 'Matematica',
        (SELECT id FROM teacher WHERE username = 'marco.gialli'), '2025-02-05', 'WRITTEN', 8,
        'Compito sui sistemi lineari.'),
       ((SELECT id FROM student WHERE username = 'sofia.bianchi'), 'Italiano',
        (SELECT id FROM teacher WHERE username = 'elisa.gialli'), '2025-02-10', 'ORAL', 7,
        'Analisi di un testo poetico.'),
       ((SELECT id FROM student WHERE username = 'giulia.rossi'), 'Italiano',
        (SELECT id FROM teacher WHERE username = 'elisa.gialli'), '2025-02-12', 'WRITTEN', 6, 'Tema: il Romanticismo.'),
       ((SELECT id FROM student WHERE username = 'giulia.rossi'), 'Inglese',
        (SELECT id FROM teacher WHERE username = 'anna.blui'), '2025-02-20', 'ORAL', 7,
        'Dialogo su un testo letterario.'),
       ((SELECT id FROM student WHERE username = 'elisa.verdi'), 'Inglese',
        (SELECT id FROM teacher WHERE username = 'anna.blui'), '2025-02-18', 'WRITTEN', 9, 'Traduzione di un brano.'),
       ((SELECT id FROM student WHERE username = 'elisa.verdi'), 'Informatica',
        (SELECT id FROM teacher WHERE username = 'elena.blui'), '2025-02-25', 'WRITTEN', 8,
        'Progetto: sviluppo di un algoritmo.'),
       ((SELECT id FROM student WHERE username = 'franco.blui'), 'Informatica',
        (SELECT id FROM teacher WHERE username = 'elena.blui'), '2025-02-14', 'WRITTEN', 7,
        'Compito sulla programmazione.'),
       ((SELECT id FROM student WHERE username = 'franco.blui'), 'Inglese',
        (SELECT id FROM teacher WHERE username = 'anna.blui'), '2025-02-22', 'ORAL', 8,
        'Esposizione di un argomento a scelta.'),
       ((SELECT id FROM student WHERE username = 'chiara.neri'), 'Italiano',
        (SELECT id FROM teacher WHERE username = 'elisa.gialli'), '2025-02-13', 'WRITTEN', 8,
        'Analisi di un testo narrativo.'),
       ((SELECT id FROM student WHERE username = 'chiara.neri'), 'Storia',
        (SELECT id FROM teacher WHERE username = 'riccardo.blui'), '2025-02-21', 'ORAL', 7,
        'Interrogazione sulla Rivoluzione Francese.');
...
VALUES ((SELECT id
         ...
         LIMIT 1), 1, '2025-01-15', 'Matematica', (SELECT id FROM teacher WHERE username = 'marco.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024)
         LIMIT 1), 2, '2025-01-15', 'Matematica', (SELECT id FROM teacher WHERE username = 'marco.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024)
         LIMIT 1), 3, '2025-01-15', 'Matematica', (SELECT id FROM teacher WHERE username = 'marco.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'A' AND year = 2024)
         LIMIT 1), 1, '2025-01-18', 'Matematica', (SELECT id FROM teacher WHERE username = 'marco.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'B' AND year = 2024)
         LIMIT 1), 4, '2025-01-17', 'Matematica', (SELECT id FROM teacher WHERE username = 'marco.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 1, '2025-01-15', 'Storia', (SELECT id FROM teacher WHERE username = 'riccardo.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 3, '2025-01-17', 'Storia', (SELECT id FROM teacher WHERE username = 'riccardo.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 4, '2025-01-17', 'Storia', (SELECT id FROM teacher WHERE username = 'riccardo.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 5, '2025-01-17', 'Storia', (SELECT id FROM teacher WHERE username = 'riccardo.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 4, '2025-01-16', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 5, '2025-01-16', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 2, '2025-01-15', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 3, '2025-01-15', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 4, '2025-01-15', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024)
         LIMIT 1), 2, '2025-01-18', 'Italiano', (SELECT id FROM teacher WHERE username = 'elisa.gialli')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024)
         LIMIT 1), 2, '2025-01-16', 'Inglese', (SELECT id FROM teacher WHERE username = 'anna.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 5 AND letter = 'A' AND year = 2024)
         LIMIT 1), 4, '2025-01-18', 'Inglese', (SELECT id FROM teacher WHERE username = 'anna.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024)
         LIMIT 1), 2, '2025-01-18', 'Informatica', (SELECT id FROM teacher WHERE username = 'elena.blui')),
       ((SELECT id
         FROM class_timetable
         WHERE school_class_id = (SELECT id FROM school_class WHERE number = 5 AND letter = 'BS' AND year = 2024)
         LIMIT 1), 3, '2025-01-18', 'Informatica', (SELECT id FROM teacher WHERE username = 'elena.blui'));
...
VALUES ((SELECT id
        ...
        (SELECT id FROM teacher WHERE username = 'marco.gialli'), FALSE),
       ((SELECT id
         FROM teaching_timeslot
       ...
       ((SELECT id FROM teaching_timeslot WHERE hour = 1 AND date = '2025-01-15' AND teaching_subject_title = 'Storia'),
        (SELECT id FROM teacher WHERE username = 'riccardo.blui'), FALSE),
       ...
       ((SELECT id
        ...
        (SELECT id FROM teacher WHERE username = 'elisa.gialli'), FALSE),
       ((SELECT id
         FROM teaching_timeslot
       ...
       ((SELECT id
        ...
        (SELECT id FROM teacher WHERE username = 'anna.blui'), FALSE),
       ((SELECT id
         FROM teaching_timeslot
       ...
       ((SELECT id
        ...
        (SELECT id FROM teacher WHERE username = 'elena.blui'), FALSE),
       ((SELECT id
         FROM teaching_timeslot
...
VALUES ((SELECT id
         ...
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'marco.gialli')), 3, '2025-01-17', 4, 1,
        'In presenza'),
       ((SELECT id
         FROM reception_timetable
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'marco.gialli')), 4, '2025-01-18', 6, 1, 'Online'),
       ((SELECT id FROM reception_timetable WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elena.blui')),
        1, '2025-01-20', 5, 2, 'Online'),
       ((SELECT id FROM reception_timetable WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elena.blui')),
        2, '2025-01-21', 3, 1, 'In presenza'),
       ((SELECT id
         FROM reception_timetable
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'riccardo.blui')), 3, '2025-01-22', 4, 3,
        'In presenza'),
       ((SELECT id
         FROM reception_timetable
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'riccardo.blui')), 4, '2025-01-23', 5, 2,
        'Online'),
       ((SELECT id
         FROM reception_timetable
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elisa.gialli')), 1, '2025-01-24', 4, 2, 'Online'),
       ((SELECT id
         FROM reception_timetable
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elisa.gialli')), 2, '2025-01-25', 3, 1,
        'In presenza'),
       ((SELECT id FROM reception_timetable WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'anna.blui')),
        1, '2025-01-26', 5, 3, 'In presenza'),
       ((SELECT id FROM reception_timetable WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'anna.blui')),
        2, '2025-01-27', 6, 2, 'Online');
...
VALUES ((SELECT teaching_timeslot_id
         ...
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'marco.gialli')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 3 AND date = '2025-01-15' LIMIT 1)),
        'Lezione di Matematica', 'Approfondimento sulle funzioni quadratiche.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'marco.gialli')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 1 AND date = '2025-01-18' LIMIT 1)),
        'Lezione di Matematica', 'Ripasso sulle equazioni di secondo grado.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elena.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 3 AND date = '2025-01-18' LIMIT 1)),
        'Laboratorio di Informatica', 'Sviluppo di un programma semplice in Python.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'riccardo.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 3 AND date = '2025-01-17' LIMIT 1)),
        'Lezione di Storia', 'Discussione sulle principali invenzioni.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'riccardo.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 5 AND date = '2025-01-17' LIMIT 1)),
        'Lezione di Storia', 'Analisi degli eventi della Seconda Guerra Mondiale.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'elisa.gialli')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 5 AND date = '2025-01-16' LIMIT 1)),
        'Lezione di Italiano', 'Introduzione alla Divina Commedia di Dante Alighieri.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'anna.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 2 AND date = '2025-01-16' LIMIT 1)),
        'Lezione di Inglese', 'Approfondimento sulla grammatica.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'anna.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 4 AND date = '2025-01-18' LIMIT 1)),
...
VALUES ((SELECT teaching_timeslot_id
         ...
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'marco.gialli')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 1 AND date = '2025-01-18' LIMIT 1)),
        '2025-01-25', 'Esercizi sulle equazioni', 'Risolvere gli esercizi da 1 a 10 a pagina 50 del libro di testo.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'riccardo.blui')
           AND
             teaching_timeslot_id = (SELECT id FROM teaching_timeslot WHERE hour = 5 AND date = '2025-01-17' LIMIT 1)),
        '2025-01-24', 'Esercizi Rivoluzione Francese', 'Completa le domande a pagina 150.'),
       ((SELECT teaching_timeslot_id
         FROM signed_hour
         WHERE teacher_id = (SELECT id FROM teacher WHERE username = 'anna.blui')
           AND
...
VALUES ((SELECT signed_hour_teaching_timeslot_id FROM homework WHERE title = 'Esercizi sulle equazioni'),
        'Dubbio esercizio 3', (SELECT id FROM student WHERE username = 'luca.verdi')),
...
VALUES (NULL, (SELECT id FROM teacher WHERE username = 'marco.gialli'), 'Problema con la piattaforma', 'Piattaforma',
       ...
       (NULL, (SELECT id FROM teacher WHERE username = 'marco.gialli'), 'Chiarimento sulle lezioni', 'Didattica',
        '2025-03-20 14:00:00', FALSE, FALSE),
...
VALUES ((SELECT id FROM student WHERE username = 'luca.verdi'), (SELECT id FROM parent WHERE username = 'paolo.verdi')),
       ((SELECT id FROM student WHERE username = 'sofia.bianchi'),
...
VALUES ((SELECT id FROM school_class WHERE number = 3 AND letter = 'C' AND year = 2024),
