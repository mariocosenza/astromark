            ...
            <Box sx={{height: '100%', width: '80vw', m: 'auto', flex: 1}}>
                <Grid container rowSpacing={1} columnSpacing={{xs: 1, sm: 2, md: 3}} mx='0%' mt='5%'>
                    ...
                    <Grid size={6} sx={{textAlign: 'center'}}>
                        <img style={{maxWidth: '70%', maxHeight: '70%'}} src={mark}
                             alt={'Immagine della dashboard voti'}/>
                    </Grid>
                    <Grid size={6}>
                        <Typography variant={"body1"}>
                            Iscriviti alla nostra piattaforma e offri alla tua scuola un registro elettronico innovativo
                            e intuitivo.
                            Con strumenti per la gestione delle presenze, delle valutazioni e una comunicazione fluida
                            con studenti e genitori, rendiamo la gestione scolastica semplice e accessibile a tutti!
                        </Typography>
                    </Grid>
                    <Grid size={6} sx={{textAlign: 'center'}}>
